...
/* compiled from: P */
/* renamed from: com.tencent.mobileqq.dt.model.FEBound */
...
public class FEBound {
    ...
    private static void transformInner(byte[] bArr, byte[] bArr2, byte[][] bArr3) {
        for (int i = 0; i < bArr.length; i++) {
            int i2 = i * 2;
            bArr2[i] = (byte) (bArr3[(i2 + 1) % 32][(byte) (bArr[i] & 15)] | (bArr3[i2 % 32][(byte) ((bArr[i] >> 4) & 15)] << 4));
        }
    }
}
